...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>filmmanage/fimewarnmanageUpdate.js"></script>
  ...
  <body>
  <form action="/cinema/filmmanage/filmmanage!goUpdatefimewarn.action" method="post" enctype="multipart/form-data" name="editForm" id="editForm">
  ...
  <table border="1" style="width: 90%" class="">
	  ...
	  <tr style="height: 25px" align="left">
	  	...
	  	<td>
  	     ...
  	     <td>
      		<font color="red">*图片尺寸为90*126</font>
   	    </td> 
	  </tr>
