...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath %>filmmanage/filmmanageStillsResult.js"></script>
  ...
  <body>
  <form id="editfimeForm" action="/cinema/filmmanage/filmmanage!stillsfimewarn.action" method="post">
     <input type="hidden" name="id" value="${id}"/>
      <input type="hidden" name="filmnameStr" value='${filmnameStr}' />
  </form>
	
	<div  style="margin-left:8px;">
		<a href="javascript:goAdds(${id})">&ensp;&ensp;[添加剧照]&ensp;&ensp;</a>
		&ensp;&ensp;
	...
	<table class="data_table" width="90%">
		...
		<tr align="center" id="commtr${list.id}">
			...
			<td>
            <a href="javascript:delfimestills('${list.id}','${list.film_d}')">[删除]</a></td>
		</tr>
		</c:forEach>
	</table>
  </body>
