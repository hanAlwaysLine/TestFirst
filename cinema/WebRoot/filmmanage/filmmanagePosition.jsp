...
<html>
	...
	<script type="text/javascript"
			src="<%=basePath%>filmmanage/filmmanagePosition.js"></script>
		<script type="text/javascript"
	...
	<body>
		<form action="/cinema/filmmanage/filmmanage!goPosition.action"
			method="post" name="editForm" id="editForm">
			<input type="hidden" id="msg" value="${msg}"/>
			<input type="hidden" name="ids" id="ids" value="<%=request.getParameter("id")%>">
					...
					<tr align="left">
						...
						<td>
							<select id="pos" name="pos" >
							  ...
							  <option style="width:50" value="6">6</option>
							  <option style="width:50" value="7" >7</option>
							  <option style="width:50" value="8">8</option>
							  <option style="width:50" value="9" >9</option>
							  <option style="width:50" value="10" >10</option>
							</select>
						</td>
					</tr>
					<tr align="center">
						<td colspan="4">
							<input type="button" onclick="position()" class="word_ft3" />
