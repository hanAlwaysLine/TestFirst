...
//	}
	...
	if(Validator.form()){
		if(a_filmno==null||a_filmno==""){
			$("#show").html("<font color='red'>不能为空!</font>"); 
			return;
		}else{
			url = "/cinema/filmmanage/filmmanage!addFilmmanageValidate.action?filmno="+a_filmno;
			jQuery.post(url, null,show);
		}
	}
}

function goBack_filmmanage(){
	url = "filmmanageQuery.jsp";
	location.href = url;
}
