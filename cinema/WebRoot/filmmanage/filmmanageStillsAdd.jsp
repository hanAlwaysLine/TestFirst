...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>common/js/jquery.validate.min.js"></script>
		<script type="text/javascript" src="<%=basePath%>filmmanage/filmmanageStillsAdd.js"></script>
  ...
  <body>
  <form action="/cinema/filmmanage/filmmanage!stillfime.action" method="post" enctype="multipart/form-data" name="addForm" id="addForm">
  <input type="hidden" id="msg" value="${msg}"/>
  <input type="hidden" name="fimewarn.warnpic" id="image" value=""/>
  <input type="hidden" name="fimewarn.film_d" id="id" value='<%=request.getParameter("id") %>'/>
  ...
  <table border="1" style="width: 90%" class="">
      <tr align="left">
		...
		<td>
			<img src="<%=basePath%>common/swfupload/images/alum_def_img.jpg" id="img" width="130px;" height="100px;"/>
	       <!-- 进度条 -->
