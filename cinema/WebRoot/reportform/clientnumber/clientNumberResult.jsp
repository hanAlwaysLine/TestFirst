...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>reportform/clientnumber/clientNumberResult.js"></script>
		<!-- css -->
	...
	<body>
		<form id="excelForm" action="/cinema/reportform/clientnum!showExcel.action" method="post">
