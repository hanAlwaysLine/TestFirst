...
<html>
  ...
  <body>
  <form action="/cinema/advertisemanage/advertise!doeditactimg.action" method="post" enctype="multipart/form-data" name="editForm" id="editForm">
  ...
  <table border="1" style="width: 90%" class="">  
	  <tr align="left">
				...
				<td><font color="red">
					...
					<c:if test="${advertisement_type == '31'}">*竖版活动图片尺寸为190*266</c:if>
					</font></td>
	 </tr>
	 <tr align="left">
	 		<td>海报(横版):</td>
