...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath %>advertisemanage/carouselchartEdit.js"></script>
		<script type="text/javascript"
	...
	<body>
		<form action="/cinema/advertisemanage/advertise!editadvertise.action"
			...
			<input type="hidden" name="advertise.advertise_id"
				value="${advertise.advertise_id}" />
			<input type="hidden" name="advertise.advertisement_type"
				value="${advertise.advertisement_type}" />
					...
					<tr align="left">
						...
						<td width="28%">
							<input type="text" id="according_id"
								name="advertise.according_id" value="${advertise.according_id}" />
						</td>
						<td width="42%">
							<div id="show">
							</div>
