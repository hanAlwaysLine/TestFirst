...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>advertisemanage/actchartResult.js"></script>
	...
	<body>
		<table class="data_table">
					...
					<s:iterator id="map" value="#request.actmsglist.objects">
						<tr align="center">
							<td>
							...
							<td>
								<div title="<s:property value="#map.LOCALE"/>" style="height:25px;line-height:25px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
