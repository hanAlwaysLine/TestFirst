function goAdd(){
	var url = "/cinema/advertisemanage/advertise!addadvertise.action?type="+3;
...
function goEdit(id){
	var url = "/cinema/advertisemanage/advertise!goedit.action?id="+id+"&type="+3;
	var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
			{
...
function posAdvertise(id){
	var url = "advertisemanage/actchartPosition.jsp?id="+id;
	var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
			{
...
function goEditImage(id,advertisement_type){
	var url = "/cinema/advertisemanage/advertise!editactwarn.action?activity.activity_id="+id+"&advertisement_type="+advertisement_type;
	var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
			{
