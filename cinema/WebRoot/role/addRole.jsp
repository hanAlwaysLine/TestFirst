...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath%>role/addRole.js"></script>
...
alertResult(msg,0);
  ...
  <body>
  <form action="/cinema/role!addRole.action" method="post"
			...
			<table>
				<tr>
					...
					<td align="left">
						<input id="title" name="role.title" style="width: 160px"/>
