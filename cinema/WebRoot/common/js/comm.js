	...
	if ($(iframe_win).attr("id") != "frameaif") {
		...
		if (isIE > 0) {
		    ...
		    {  
				...
				var idocumentElement = iframe_win.contentWindow.document.documentElement;
				if(navigator.appName == "Microsoft Internet Explorer" && navigator.appVersion .split(";")[1].replace(/[ ]/g,"")=="MSIE9.0")
				{
//					try {
//						if (idocumentElement.scrollHeight > 620) {							
//							
//							iframe_win.height -= 5;
//							iframe_win.height = idocumentElement.scrollHeight+55;
//							iframe_frameaif.height -= 5;
//							                                                   
//							iframe_frameaif.height = idocumentElement.scrollHeight+55;
//						}
//						else {
//							
//							iframe_win.height = 620;
//						}
//				   }
					...
					try {
						iframe_win.height = "0";
						iframe_frameaif.height = "0";
//					if (idocumentElement.scrollHeight > 620) {							
						iframe_win.height = idocumentElement.scrollHeight+70;
						iframe_frameaif.height = idocumentElement.scrollHeight+70;
//					}
//					else {
//						
//						iframe_win.height = 620;
...
//	 alert("scrollHeight:"+iframe_frameaif.contentDocument.body.scrollHeight);
	...
	if (isIE > 0) {
	    ...
	    {  
			...
			var idocumentElement = iframe_frameaif.contentWindow.document.documentElement;
			if(navigator.appName == "Microsoft Internet Explorer" && navigator.appVersion .split(";")[1].replace(/[ ]/g,"")=="MSIE9.0")
			{
				try {
					if (idocumentElement.scrollHeight > 620) {
						//alert('620+');
						iframe_frameaif.height -= 5;
						///alert(idocumentElement.scrollHeight);
						//iframe_frameaif.height = idocumentElement.scrollHeight;
