...
<html>
	...
	-->
		...
		<script>	
	    function toAdd(){
			var url = "/cinema/goods/goodsAdd.jsp";
			var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
					{
						title : "<div style='padding:10px;'>卖品-新增</div>", // 标题
						modal : true,// 是否开遮罩
						unloadOnHide : true
					});
			b.tween(550, 380);
	...
	<body>
		...
		<form action="/cinema/goodsmanage/goods!goodsList.action" id="queryForm"
			name="queryForm" target="result" method="post">
			<input type="hidden" id="pageNo" name="pageNo" value="1" />
			<input type="hidden" id="pageSize" name="pageSize" value="10" />
			<div class="qu_div" style="margin-left: 25px; * width: 813px;">
					<span>卖品名称:</span>
					<span><input id="GOODS_NAME" size="10"
							name="goods.GOODS_NAME" class="qu_inp1" value="" type="text" />
					</span>
