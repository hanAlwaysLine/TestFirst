...
function delActivity(id) {
	...
	parent.parent.Boxy.confirm(""+msg+"",function(){
		var url = "/cinema/goodsmanage/goods!delActivity.action";
		var params = {
				id:id
		};
...
function goEdit(id){
	var url = "/cinema/goodsmanage/goods!goedit.action?id="+id;
	var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
			{
				title : "<div style='padding:10px;'>卖品-修改</div>", // 标题
				modal : true,// 是否开遮罩
				iframeid:'goods_update',
				unloadOnHide : true
			});
	b.tween(550, 380);
}
