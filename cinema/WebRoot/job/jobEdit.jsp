...
<html>
	<head>
		...
		<script type="text/javascript"
			src="<%=basePath %>job/jobEdit.js"></script>
	...
	<body>
		<form action="/cinema/job/job!updjob.action"
			method="post" name="editForm" id="editForm" enctype="multipart/form-data">
			<input type="hidden" name="job.JOB_ID" value="${job.JOB_ID }"/>
				...
				<table style="width: 90%;">
				   <tr style="height: 25px" align="left">
						...
						<td colspan="2" align="left">
							<input name="job.JOB_NAME" id="JOB_NAME" type="text"  value="${job.JOB_NAME }"/>
						</td>                     
					</tr>
					<tr style="height: 25px" align="left">
						<td>
						...
						<td colspan="2" align="left">
						    <input type="text" name="job.JOB_LOCATION" id="JOB_LOCATION"  value="${job.JOB_LOCATION }"/>
						</td>
					</tr>
					<tr style="height: 25px" align="left">
						<td>
						...
						<td colspan="2" align="left">
						    <input type="text" name="job.JOB_TYPE" id="JOB_TYPE"  value="${job.JOB_TYPE }"/>
						</td>
					</tr>
					<tr style="height: 25px" align="left">
						<td>
						...
						<td colspan="2" align="left">
							<input type="text" name="job.JOB_COUNT" id="JOB_COUNT"  value="${job.JOB_COUNT }"/>
						</td>
					</tr>
					<tr style="height: 25px" align="left">
						<td>
						...
						<td colspan="2" align="left">
						    <input type="text" name="job.JOB_SCHOOL" id="JOB_SCHOOL"  value="${job.JOB_SCHOOL }"/>
						</td>
					</tr>
					<tr style="height: 25px" align="left">
						<td>
						...
						<td colspan="2" align="left">
							<textarea  rows="4" cols="40" name="job.JOB_CONTENT" id="JOB_CONTENT">${job.JOB_CONTENT }</textarea>
						</td>
					</tr>
					<tr>
						<td colspan="6">
