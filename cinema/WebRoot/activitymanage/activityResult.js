...
function delActivity(id) {
	var msg = "删除此活动会删除对应的广告信息,请确认!";
	parent.parent.Boxy.confirm(""+msg+"",function(){
		var url = "/cinema/activitymanage/activity!delActivity.action";
		var params = {
				id:id
		};
...
function goEdit(id){
	var url = "/cinema/activitymanage/activity!goedit.action?id="+id;
	var b = new parent.parent.Boxy.load(url,// 地址 可以带参数
			{
				title : "<div style='padding:10px;'>活动-修改</div>", // 标题
				modal : true,// 是否开遮罩
				unloadOnHide : true
			});
	b.tween(850, 600);
